"""the_crabber_17669 URL Configuration
...
admin.site.site_header = "The Crabber"
admin.site.site_title = "The Crabber Admin Portal"
admin.site.index_title = "The Crabber Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="The Crabber API",
        default_version="v1",
        description="API documentation for The Crabber App",
    ),
    public=True,
